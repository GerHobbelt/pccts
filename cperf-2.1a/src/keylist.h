...
typedef struct key_list
{
  ...
  boolean    occurrence_sort;       /* True if sorting by occurrence. */
  boolean    hash_sort;             /* True if sorting by hash value. */
  boolean    additional_code;       /* True if any additional C code is included. */
} KEY_LIST;
