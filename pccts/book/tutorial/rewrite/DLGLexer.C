...
TokenType DLGLexer::act1()
{ 
		return (TokenType)1;
	}


TokenType DLGLexer::act2()
{ 
		skip();  
		return (TokenType)2;
	}
...
TokenType DLGLexer::act4()
{ 
		return EXP;
	}


TokenType DLGLexer::act5()
{ 
		return ADD;
	}


TokenType DLGLexer::act6()
{ 
		return ID;
	}


TokenType DLGLexer::act7()
{ 
		return INT;
	}
