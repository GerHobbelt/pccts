...
#define zzOvfChk														\
            if ( zzasp <= 0 )                                           \
            {                                                           \
                printf(zzStackOvfMsg, __FILE__, __LINE__);		\
                exit(-1);                                               \
            }
...
#define zzfailed_pred(_p)	\
	printf("semantic error; failed predicate: '%s'\n",_p)
#endif
...
#ifndef zzTRACEIN
#define zzTRACEIN(r)	printf("enter rule \"%s\"\n", r);
#endif
#ifndef zzTRACEOUT
#define zzTRACEOUT(r)	printf("exit rule \"%s\"\n", r);
#endif
