...
P::statement(ASTBase **_root)
{
  ...
  zzTRACEIN("statement");
  {
    ...
    while ( (LA(1)==Number || LA(1)==10) ) {
      ...
      "Result=%f\n",e_ast->eval());
      e_ast->dumpTree();
      zzmatch(NL); _t22 = (ANTLRTokenPtr)LT(1);
      _ast22 = new AST(_t22);
...
P::expr1(ASTBase **_root)
{
  ...
  (*_root)=a_ast;
  {
    ...
    AST *_ast21=NULL,*_ast22=NULL;
    for (;;) {
      if ( !((LA(1)==6 || LA(1)==7))) break;
      if ( (LA(1)==6) ) {
        zzmatch(6); _t21 = (ANTLRTokenPtr)LT(1); consume();
        _ast = NULL;
        expr2(&_ast);
        _ast22 = (AST *)_ast;
        b_ast = _ast22;
        ...
        if ( (LA(1)==7) ) {
          zzmatch(7); _t21 = (ANTLRTokenPtr)LT(1); consume();
          _ast = NULL;
          expr2(&_ast);
          _ast22 = (AST *)_ast;
          c_ast = _ast22;
...
P::expr2(ASTBase **_root)
{
  ...
  (*_root)=a_ast;
  {
    ...
    for (;;) {
      ...
      if ( (LA(1)==8) ) {
        zzmatch(8); _t21 = (ANTLRTokenPtr)LT(1); consume();
        _ast = NULL;
        expr3(&_ast);
        _ast22 = (AST *)_ast;
        b_ast = _ast22;
        ...
        if ( (LA(1)==9) ) {
          zzmatch(9); _t21 = (ANTLRTokenPtr)LT(1); consume();
          _ast = NULL;
          expr3(&_ast);
          _ast22 = (AST *)_ast;
          c_ast = _ast22;
...
P::expr3(ASTBase **_root)
{
  ...
  if ( (
LA(1)==Number) ) {
    zzmatch(Number); _t11 = (ANTLRTokenPtr)LT(1);
    _ast11 = new AST(_t11);
 ...
 consume();
    ...
    if ( (LA(1)==10) ) {
      zzmatch(10); _t11 = (ANTLRTokenPtr)LT(1);  consume();
      _ast = NULL;
      expr1(&_ast);
      if ( _tail==NULL ) _sibling = _ast; else _tail->setRight(_ast);
      _ast12 = (AST *)_ast;
      ASTBase::link(_root, &_sibling, &_tail);
      zzmatch(11); _t13 = (ANTLRTokenPtr)LT(1);  consume();
    }
