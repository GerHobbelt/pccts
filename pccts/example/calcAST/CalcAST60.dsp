...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "." /I "..\..\h" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /c
...
# ADD LINK32  kernel32.lib user32.lib comdlg32.lib advapi32.lib shell32.lib uuid.lib /nologo /subsystem:console /machine:I386 /out:".\Release\CalcAST.exe"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "." /I "..\..\h" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "PCCTS_USE_NAMESPACE_STD" /FR /FD /c
# SUBTRACT CPP /YX
...
BuildCmds= \
	...
	..\..\bin\dlg.exe -emsvc -CC -C2 -i parser.dlg \
