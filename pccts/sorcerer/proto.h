...
extern int DumpNextNameInDef( char **q, FILE *output, const char* file, int line );
extern void DumpListOfParmNames( char *pdecl, FILE *output, const char* file, int line );
extern SymEntry *define_token(char *text);
extern char *actiondup(char *s);
extern AST *read_sor_desc(FILE *f);
extern void DumpType( char *s, FILE *f, const char *file, int line );
